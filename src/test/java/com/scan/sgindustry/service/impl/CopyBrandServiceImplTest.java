...
import com.scan.sgindustry.tools.ErrorCode;
...
public class CopyBrandServiceImplTest {
    ...
    public void updateBatchByPrimaryKeySelective() {
        ...
        //ist<CopyBrandDetails> copyBrandDetails = copyBrandDetailsService.selectByNoticeNumber(noticeNumber);
        //int id = copyBrandDetails.get(0).getId();
        /*for(CopyBrandDetails details : copyBrandDetails) {
            details.setNoticeNumber("");
        }*/
        System.out.println(ErrorCode.codeMessage.get("101"));
